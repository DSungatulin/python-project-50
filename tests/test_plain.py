...
def test_get_plain_view():
    ...
    assert get_plain_view('path_to_property', 'CHANGED', 'old_value', 'new_value') == "Property 'path_to_property' was updated. From 'old_value'\n            to 'new_value'"
...
def test_get_plained():
    ...
    expected_output = "\n".join([
        ...
        "Property 'yet_another_property' was updated. From 'old_value'\n            to 'new_value'"
    ])
